...
import {AbstractChangeRequest} from '../../../../../change-notice/project/project-change-notice-details/project-change-notice-define/mat-dialog-linked-change-requests/mat-dialog-linked-change-requests';
import {ConfigurationService} from '../../../../../core/services/configurations/configuration.service';
import {HelpersService} from '../../../../../core/utilities/helpers.service';

@Component({
  selector: 'mc-linked-change-request-dialog',
  templateUrl: './project-mat-dialog-linked-change-requests.component.html',
  styleUrls: ['./project-mat-dialog-linked-change-requests.component.scss'],
  providers: [ProjectLinkedChangeRequestDialogService]
})

export class ProjectMatDialogLinkedChangeRequestsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(public dialogRef: MatDialogRef<ProjectMatDialogLinkedChangeRequestsComponent>,
              private readonly formBuilder: FormBuilder,
              public readonly helpersService: HelpersService,
              @Inject(MAT_DIALOG_DATA) public data: any,
              private readonly linkedChangeRequestDialogService: ProjectLinkedChangeRequestDialogService) {
