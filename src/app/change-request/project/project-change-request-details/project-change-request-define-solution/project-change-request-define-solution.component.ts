...
import {CaseObject, ChangeRequest, ImpactedItem} from '../../../../shared/models/mc.model';
import {
  CaseObjectLabel,
  CaseObjectRouterPath,
  CaseObjectServicePath
} from '../../../../shared/components/case-object-list/case-object.enum';
import {ProjectMatDialogLinkedChangeRequestsComponent} from './project-mat-dialog-linked-change-requests/project-mat-dialog-linked-change-requests.component';
...
import {ProjectChangeRequestDefineScopeDialogComponent} from './project-change-request-define-scope-dialog/project-change-request-define-scope-dialog.component';
...
@Component({
  selector: 'mc-project-change-request-define-solution',
  templateUrl: './project-change-request-define-solution.component.html',
  styleUrls: ['./project-change-request-define-solution.component.scss']
})

export class ProjectChangeRequestDefineSolutionComponent implements OnInit, OnChanges {
  @Input()
  caseActions: string[];
  @Input()
  ...
  openChangeRequestAddDialog(): void {
    let dialogRef: MatDialogRef<ProjectMatDialogLinkedChangeRequestsComponent>;
    dialogRef = this.linkedChangeRequestsDialog.open(ProjectMatDialogLinkedChangeRequestsComponent, {
      width: '50rem',
      data: {
  ...
  updateDescription(data) {
    this.changeRequestFormGroup.get('solution_definition.aligned_with_fo_details').setValue(data.aligned_with_fo_details);
  }
  ...
  openDefineScopeDialog(): void {
    let dialogRef: MatDialogRef<ProjectChangeRequestDefineScopeDialogComponent>;
    dialogRef = this.matDialog.open(ProjectChangeRequestDefineScopeDialogComponent, {
      width: '80rem',
      disableClose: true,
      data: {
