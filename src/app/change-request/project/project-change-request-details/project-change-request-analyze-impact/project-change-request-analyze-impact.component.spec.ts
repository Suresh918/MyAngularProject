...
import {ProjectChangeRequestAnalyzeImpactComponent} from './project-change-request-analyze-impact.component';
...
describe('ProjectChangeRequestAnalyzeImpactComponent', () => {
  let component: ProjectChangeRequestAnalyzeImpactComponent;
  let fixture: ComponentFixture<ProjectChangeRequestAnalyzeImpactComponent>;
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ProjectChangeRequestAnalyzeImpactComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ProjectChangeRequestAnalyzeImpactComponent);
