...
import {ProjectImplementationStrategyComponent} from './project-implementation-strategy.component';



describe('ImplementationStrategyComponent', () => {
  let component: ProjectImplementationStrategyComponent;
  let fixture: ComponentFixture<ProjectImplementationStrategyComponent>;
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [ ProjectImplementationStrategyComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ProjectImplementationStrategyComponent);
