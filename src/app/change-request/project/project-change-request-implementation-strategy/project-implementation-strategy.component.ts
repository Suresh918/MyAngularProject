...
@Component({
  selector: 'mc-project-implementation-strategy',
  templateUrl: './project-implementation-strategy.component.html',
  styleUrls: ['./project-implementation-strategy.component.scss'],
})
export class ProjectImplementationStrategyComponent extends ChangeRequestImplementationStrategyCoreComponent implements OnInit {
