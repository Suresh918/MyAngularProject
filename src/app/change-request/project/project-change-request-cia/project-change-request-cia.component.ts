...
@Component({
  selector: 'mc-project-change-request-cia',
  templateUrl: './project-change-request-cia.component.html',
  styleUrls: ['./project-change-request-cia.component.scss']
})
export class ProjectChangeRequestCIAComponent extends ChangeRequestCIACoreComponent implements OnInit {
