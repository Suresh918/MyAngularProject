...
import {CreatorCrOfflineDecisionComponent} from './cr-offline-decision.component';
...
describe('CreatorCrOfflineDecisionComponent', () => {
  let component: CreatorCrOfflineDecisionComponent;
  let fixture: ComponentFixture<CreatorCrOfflineDecisionComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [CreatorCrOfflineDecisionComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CreatorCrOfflineDecisionComponent);
