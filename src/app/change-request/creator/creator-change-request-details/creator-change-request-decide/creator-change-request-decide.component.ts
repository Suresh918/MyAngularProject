...
@Component({
  selector: 'mc-creator-change-request-decide',
  templateUrl: './creator-change-request-decide.component.html',
  styleUrls: ['./creator-change-request-decide.component.scss'],
  providers: [ChangeRequestService]
})

export class CreatorChangeRequestDecideComponent implements OnInit, OnChanges {
  @Input()
  id: string;
  @Input()
  ...
  @Output()
  private readonly getAddDecisionState: EventEmitter<void> = new EventEmitter<void>();
  @Output()
  private readonly setPriorityStatus: EventEmitter<any> = new EventEmitter<any>();
