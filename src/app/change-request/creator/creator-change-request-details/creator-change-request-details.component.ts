...
import {CaseActionElement, ChangeRequest, ImpactedItem} from '../../../shared/models/mc.model';
...
@Component({
  selector: 'mc-creator-change-request-details',
  templateUrl: './creator-change-request-details.component.html',
  styleUrls: ['./creator-change-request-details.component.scss'],
  providers: [CheckItemPipe, ChangeNoticeService]
})

export class CreatorChangeRequestDetailsComponent extends ChangeRequestDetailsCoreComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    // this.getLinkedProblemItems(this.param);
