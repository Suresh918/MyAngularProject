...
import {CreatorMatDialogLinkedChangeRequestsComponent} from './creator-mat-dialog-linked-change-requests.component';
...
describe('MatDialogLinkedChangeRequestsComponent', () => {
  let component: CreatorMatDialogLinkedChangeRequestsComponent;
  let fixture: ComponentFixture<CreatorMatDialogLinkedChangeRequestsComponent>;
  const dialogMock = {
    close: () => { }
  };
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [CreatorMatDialogLinkedChangeRequestsComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CreatorMatDialogLinkedChangeRequestsComponent);
  ...
  it('should set results, when linkedChangeRequests$ service call returns successful response', () => {
    ...
    component.paginator.pageIndex = 1;
    component.paginator.pageSize = 25;
    const xService = fixture.debugElement.injector.get(CreatorLinkedChangeRequestDialogService);
...
class CreatorLinkedChangeRequestDialogServiceMock {
