...
import {CreatorChangeRequestDetailsComponent} from './creator-change-request-details.component';
...
describe('CreatorChangeRequestDetailsComponent', () => {
  let component: CreatorChangeRequestDetailsComponent;
  let fixture: ComponentFixture<CreatorChangeRequestDetailsComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [CreatorChangeRequestDetailsComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CreatorChangeRequestDetailsComponent);
