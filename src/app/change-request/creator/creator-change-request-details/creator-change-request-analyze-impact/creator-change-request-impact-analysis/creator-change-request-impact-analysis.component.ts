...
@Component({
  selector: 'mc-creator-change-request-impact-analysis',
  templateUrl: './creator-change-request-impact-analysis.component.html',
  styleUrls: ['./creator-change-request-impact-analysis.component.scss']
})
export class CreatorChangeRequestImpactAnalysisComponent implements OnInit, OnChanges {
