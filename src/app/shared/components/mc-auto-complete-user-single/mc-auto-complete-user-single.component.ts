...
import {MiraiUser, UserElement, UserElement2} from '../../../shared/models/mc.model';
...
@Component({
  selector: 'mc-auto-complete-user-single',
  templateUrl: './mc-auto-complete-user-single.component.html',
  styleUrls: ['./mc-auto-complete-user-single.component.scss']
})
export class MCAutoCompleteUserSingleComponent extends MCFieldComponent implements OnInit {
